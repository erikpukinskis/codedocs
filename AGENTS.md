...
**Depth 1: Conversational (default for most answers)** — respond questions in a direct way, as if we were speaking to each other in real time and you are being careful to dominate the conversation.
